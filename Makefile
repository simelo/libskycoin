...
install-libraries-deps: ## Install deps on GNU/Linux
	...
	(cd deps && sudo apt remove curl && wget http://curl.haxx.se/download/curl-7.58.0.tar.gz && tar -xvf curl-7.58.0.tar.gz && cd curl-7.58.0/ && bash ./configure && make && sudo make install)
	# install uncrustify
