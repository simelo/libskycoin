...
//     result = SKY_coin_Transaction_In_SetSHA(&handle, sha256, 0);
//     ck_assert(result == SKY_OK);
//     GoUint16 r;
...
//     coin__UxArray SliceOut = {bufferSiceOut, 0, 1024};
//     result = SKY_coin_Transaction_GetOut(handle, &SliceOut);
//     ck_assert(result == SKY_OK);
//     coin__TransactionOutput* pOutput = SliceOut.data;
...
//     makeTransaction(&handle);
//     cipher__Sig nullsig = "";
//     result = SKY_coin_Transaction_Sigs_SetSig(&handle, nullsig, 0);
