...
//export SKY_cipher_MustNewPubKey
func SKY_cipher_MustNewPubKey(_b []byte, _arg1 *C.cipher__PubKey) (____error_code uint32) {
	____error_code = 0
	b := *(*[]byte)(unsafe.Pointer(&_b))
	__arg1 := cipher.MustNewPubKey(b)
	copyToBuffer(reflect.ValueOf(__arg1[:]), unsafe.Pointer(_arg1), uint(SizeofPubKey))
	return
}
...
func SKY_cipher_MustPubKeyFromHex(_s string, _arg1 *C.cipher__PubKey) (____error_code uint32) {
	____error_code = 0
	s := _s
...
//export SKY_cipher_MustPubKeyFromSecKey
func SKY_cipher_MustPubKeyFromSecKey(_seckey *C.cipher__SecKey, _arg1 *C.cipher__PubKey) (____error_code uint32) {
	____error_code = 0
	seckey := *(*cipher.SecKey)(unsafe.Pointer(_seckey))
	__arg1 := cipher.MustPubKeyFromSecKey(seckey)
	copyToBuffer(reflect.ValueOf(__arg1[:]), unsafe.Pointer(_arg1), uint(SizeofPubKey))
	return
}
...
//export SKY_cipher_MustPubKeyFromSig
func SKY_cipher_MustPubKeyFromSig(_sig *C.cipher__Sig, _hash *C.cipher__SHA256, _arg2 *C.cipher__PubKey) (____error_code uint32) {
	____error_code = 0
	sig := *(*cipher.Sig)(unsafe.Pointer(_sig))
	hash := *(*cipher.SHA256)(unsafe.Pointer(_hash))
	__arg2 := cipher.MustPubKeyFromSig(sig, hash)
	copyToBuffer(reflect.ValueOf(__arg2[:]), unsafe.Pointer(_arg2), uint(SizeofPubKey))
	return
}
...
//export SKY_cipher_MustNewSecKey
func SKY_cipher_MustNewSecKey(_b []byte, _arg1 *C.cipher__SecKey) (____error_code uint32) {
	____error_code = 0
	b := *(*[]byte)(unsafe.Pointer(&_b))
	__arg1 := cipher.MustNewSecKey(b)
	copyToBuffer(reflect.ValueOf(__arg1[:]), unsafe.Pointer(_arg1), uint(SizeofSecKey))
	return
}
...
//export SKY_cipher_MustECDH
func SKY_cipher_MustECDH(_pub *C.cipher__PubKey, _sec *C.cipher__SecKey, _arg2 *C.GoSlice_) (____error_code uint32) {
	____error_code = 0
	pub := *(*cipher.PubKey)(unsafe.Pointer(_pub))
	sec := *(*cipher.SecKey)(unsafe.Pointer(_sec))
	__arg2 := cipher.MustECDH(pub, sec)
	copyToGoSlice(reflect.ValueOf(__arg2), _arg2)
	return
}
...
//export SKY_cipher_MustNewSig
func SKY_cipher_MustNewSig(_b []byte, _arg1 *C.cipher__Sig) (____error_code uint32) {
	____error_code = 0
	b := *(*[]byte)(unsafe.Pointer(&_b))
	__arg1 := cipher.MustNewSig(b)
	copyToBuffer(reflect.ValueOf(__arg1[:]), unsafe.Pointer(_arg1), uint(SizeofSig))
	return
}
...
func SKY_cipher_MustSignHash(_hash *C.cipher__SHA256, _sec *C.cipher__SecKey, _arg2 *C.cipher__Sig) (____error_code uint32) {
	...
	hash := *(*cipher.SHA256)(unsafe.Pointer(_hash))
	sec := *(*cipher.SecKey)(unsafe.Pointer(_sec))
	__arg2 := cipher.MustSignHash(hash, sec)
	copyToBuffer(reflect.ValueOf(__arg2[:]), unsafe.Pointer(_arg2), uint(SizeofSig))
	return
}
...
//export SKY_cipher_MustGenerateDeterministicKeyPair
func SKY_cipher_MustGenerateDeterministicKeyPair(_seed []byte, _arg1 *C.cipher__PubKey, _arg2 *C.cipher__SecKey) (____error_code uint32) {
	____error_code = 0
	seed := *(*[]byte)(unsafe.Pointer(&_seed))
	__arg1, __arg2 := cipher.MustGenerateDeterministicKeyPair(seed)
	copyToBuffer(reflect.ValueOf(__arg1[:]), unsafe.Pointer(_arg1), uint(SizeofPubKey))
	copyToBuffer(reflect.ValueOf(__arg2[:]), unsafe.Pointer(_arg2), uint(SizeofSecKey))
	return
}
...
//export SKY_cipher_MustDeterministicKeyPairIterator
func SKY_cipher_MustDeterministicKeyPairIterator(_seed []byte, _arg1 *C.GoSlice_, _arg2 *C.cipher__PubKey, _arg3 *C.cipher__SecKey) (____error_code uint32) {
	____error_code = 0
	seed := *(*[]byte)(unsafe.Pointer(&_seed))
	__arg1, __arg2, __arg3 := cipher.MustDeterministicKeyPairIterator(seed)
	copyToGoSlice(reflect.ValueOf(__arg1), _arg1)
	copyToBuffer(reflect.ValueOf(__arg2[:]), unsafe.Pointer(_arg2), uint(SizeofPubKey))
	copyToBuffer(reflect.ValueOf(__arg3[:]), unsafe.Pointer(_arg3), uint(SizeofSecKey))
	return
...
//export SKY_cipher_MustGenerateDeterministicKeyPairs
func SKY_cipher_MustGenerateDeterministicKeyPairs(_seed []byte, _n int, _arg2 *C.GoSlice_) (____error_code uint32) {
	____error_code = 0
	seed := *(*[]byte)(unsafe.Pointer(&_seed))
	n := _n
	__arg2 := cipher.MustGenerateDeterministicKeyPairs(seed, n)
	copyToGoSlice(reflect.ValueOf(__arg2), _arg2)
	return
}
...
//export SKY_cipher_MustGenerateDeterministicKeyPairsSeed
func SKY_cipher_MustGenerateDeterministicKeyPairsSeed(_seed []byte, _n int, _arg2 *C.GoSlice_, _arg3 *C.GoSlice_) (____error_code uint32) {
	____error_code = 0
	seed := *(*[]byte)(unsafe.Pointer(&_seed))
	n := _n
	__arg2, __arg3 := cipher.MustGenerateDeterministicKeyPairsSeed(seed, n)
	copyToGoSlice(reflect.ValueOf(__arg2), _arg2)
	copyToGoSlice(reflect.ValueOf(__arg3), _arg3)
	return
}
